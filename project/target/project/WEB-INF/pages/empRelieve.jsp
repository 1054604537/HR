...
<div>
    <form method="get" action="empRelieve1">


        <select id="riDept" onchange="change()" name="deptId">
        </select>

        <select id="id2" name="jobId">
        </select>
        <br/>

        <input type="submit" value="确定" onclick="return confirm('换岗成功')"/>
